...
>(props: TextInputProps<TFieldValues, TName>) => {
    ...
    const {
        name, rules, shouldUnregister, defaultValue, control, disabled, label, type = 'text',
        onFocus,
        onBlur,
        className,
        ...rest
        ...
        <>
            ...
            <input
                ...
                className={`bg-[#18191E] border placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5 transition-all focus:outline-none ${
                    hasError ? "border-red-500 focus:ring-2 focus:ring-red-500" : "border-[#33353F] focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                } ${className}`}
