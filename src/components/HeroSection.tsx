    ...
    return (
        <section className="items-center lg:pt-16">
            ...
            <div className="grid grid-cols-12 lg:grid-cols-1">
                ...
                <Link
                    href="/#contact"
                    className="max-w-max border-1 border-transparent bg-gradient-to-br from-purple-400 to-indigo-500 p-[1px] rounded-full transition-all duration-300 ease-in-out "
                >
